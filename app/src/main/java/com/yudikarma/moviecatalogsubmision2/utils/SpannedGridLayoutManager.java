...
public class SpannedGridLayoutManager extends RecyclerView.LayoutManager {
    ...
    public SpannedGridLayoutManager(int columns, float cellAspectRatio,GridSpanLookup spanLookup) {
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        while (availableSpace > 0 && lastVisiblePosition < lastItemPosition/*lastVisiblePosition < lastItemPosition*/) {
